...
module.exports = function (temName, projectName) {
  co(generator(temName, projectName));
};

let generator = function *(temName, projectName) {
  ...
  if (!projectName) {
    projectName = yield prompt('\nplease enter the project name (wow-demo): ');
